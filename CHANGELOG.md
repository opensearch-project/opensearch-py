...
- Bump `actions/download-artifact` from 6 to 8 ([#988](https://github.com/opensearch-project/opensearch-py/pull/988), [#1002](https://github.com/opensearch-project/opensearch-py/pull/1002))
