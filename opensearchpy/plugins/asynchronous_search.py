...
class AsynchronousSearchClient(NamespacedClient):
    ...
    def search(
        ...
        :arg keep_on_completion: Whether you want to save the results in
            the cluster after the search is complete. You can examine the stored
        ...
        :arg wait_for_completion_timeout: The amount of time that you
            ...
            on an ID. The maximum value is 300 seconds. Default is `1s`.
        """
        return self.transport.perform_request(
            "POST",
    ...
    def stats(
        ...
        """
        Monitors any asynchronous searches that are `running`, `completed`,
        `persisted`.
