...
class AWSV4SignerAsyncAuth:
    ...
    async def _sign_request(self, method, url, query_string, body):
        """
        ...
        from aiobotocore.auth import SigV4Auth
        from aiobotocore.awsrequest import AWSRequest
        ...
        await sig_v4_auth.add_auth(aws_request)
