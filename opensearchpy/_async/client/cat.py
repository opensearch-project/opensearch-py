...
class CatClient(NamespacedClient):
    ...
    async def indices(
        ...
        :arg source: The URL-encoded request definition. Useful for
            libraries that do not accept a request body for non-POST requests.
        :arg time: Specifies the time units. Valid choices are d, h, m,
            micros, ms, nanos, s.
        :arg v: Enables verbose mode, which displays column headers.
            Default is false.
        """
    ...
    async def nodes(
        ...
        :arg full_id: When `true`, returns the full node ID. When
            `false`, returns the shortened node ID. Default is false.
        :arg h: A comma-separated list of column names to display.
        :arg help: Return help information. Default is false.
        :arg human: Whether to return human readable values for
            statistics. Default is True.
    ...
    async def segment_replication(
        ...
        :arg error_trace: Whether to include the stack trace of returned
            errors. Default is false.
        :arg expand_wildcards: Whether to expand the wildcard expression
            to include concrete indexes that are open, closed, or both.
        :arg filter_path: Used to reduce the response. This parameter
            takes a comma-separated list of filters. It supports using wildcards to
            match any field or part of a field’s name. You can also exclude fields
            with "-".
