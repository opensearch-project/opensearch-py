...
class AsyncOpenSearch(Client):
    ...
    async def _get(self, url, headers=None, params=None, body=None):
        """
    ...
    async def _head(self, url, headers=None, params=None, body=None):
        """
    ...
    async def _post(self, url, headers=None, params=None, body=None):
        """
    ...
    async def _delete(self, url, headers=None, params=None, body=None):
        """
    ...
    async def _put(self, url, headers=None, params=None, body=None):
        """
