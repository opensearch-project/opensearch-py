...
### Security
- Raise `install_requires` floors so consumers inherit CVE-free transitive versions: `requests>=2.33.0` (CVE-2024-47081, CVE-2026-25645), `aiohttp>=3.14.1` in the `[async]` extra (CVE-2026-54273..54280 et al.), and add an `idna>=3.18` floor (CVE-2026-45409); `urllib3` is already floored at `>=2.7.0`. Resolves #1083 ([#TODO_PR_NUMBER](https://github.com/opensearch-project/opensearch-py/pull/TODO_PR_NUMBER))
