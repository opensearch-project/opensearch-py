...
class SmClient(NamespacedClient):
    ...
    async def create_policy(
        ...
        :arg policy_name: The snapshot management policy name.
    ...
    async def get_policies(
        ...
        :arg filter_path: Used to reduce the response. This parameter
            ...
            match any field or part of a field’s name. You can also exclude fields
            with "-".
        :arg from_: The index to retrieve snapshot management policies
            from. Default is 0.
        :arg human: Whether to return human readable values for
            statistics. Default is True.
        :arg pretty: Whether to pretty format the returned JSON
            response. Default is false.
        :arg queryString: Filters the returned snapshot management
            policies based on query string.
        :arg size: The number of snapshot management policies to return.
        :arg sortField: The name of the query field to sort on.
        :arg sortOrder: The order to sort the snapshot management policy
            result. Valid choices are asc, desc.Default is asc.
        :arg source: The URL-encoded request definition. Useful for
            libraries that do not accept a request body for non-POST requests.
        """
    ...
    async def get_policy(
        ...
        :arg policy_name: The snapshot management name.
        :arg error_trace: Whether to include the stack trace of returned
            errors. Default is false.
        :arg filter_path: Used to reduce the response. This parameter
            takes a comma-separated list of filters. It supports using wildcards to
