...
class MlClient(NamespacedClient):
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def create_memory_container_session(
        self,
        *,
        memory_container_id: Any,
        body: Any = None,
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def delete_agentic_memory(
        self,
        *,
        memory_container_id: Any,
        doc_type: Any,
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def delete_agentic_memory_query(
        self,
        *,
        memory_container_id: Any,
        doc_type: Any,
    ...
    async def delete_memory_container(
        self,
        *,
        memory_container_id: Any,
        params: Any = None,
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def predict_model_stream(
        self,
        *,
        model_id: Any,
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def search_agentic_memory(
        self,
        *,
        memory_container_id: Any,
        doc_type: Any,
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def search_memory_container(
        self,
        *,
        body: Any = None,
        params: Any = None,
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def update_agentic_memory(
        self,
        *,
        memory_container_id: Any,
        doc_type: Any,
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "source")
    async def update_memory_container(
        self,
        *,
        memory_container_id: Any,
        body: Any = None,
